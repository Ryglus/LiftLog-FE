        ...
        <div className="human-body-container">
            <div className="human-body-wrapper" style={{ transform: `scale(${scale})` }}>
                <div className="human-body">
                    ...
                    <svg data-position='head' id='head' className='head' xmlns='http://www.w3.org/2000/svg'
                         width='56.594'
                    ...
                    <img src={path ? "http://localhost:8081/" + path : (defaultAvatar)} alt="Profile Avatar" className="avatar-image"/>
                    ...
                    <svg data-position='right-arm' id='right-arm' className='right-arm'
                    ...
                    <svg data-position='chest' id='chest' className='chest' xmlns='http://www.w3.org/2000/svg'
                    ...
                    <svg data-position='right-leg' id='right-leg' className='right-leg'
                         xmlns='http://www.w3.org/2000/svg'
                    ...
                    <svg data-position='left-hand' id='left-hand' className='left-hand'
                         xmlns='http://www.w3.org/2000/svg'
                    ...
                    <svg data-position='right-hand' id='right-hand' className='right-hand'
                    ...
                    <svg data-position='left-foot' id='left-foot' className='left-foot'
                         xmlns='http://www.w3.org/2000/svg'
                    ...
                    <svg data-position='right-foot' id='right-foot' className='right-foot'
                         xmlns='http://www.w3.org/2000/svg' width='90' height='38.938' viewBox='0 0 90 38.938'>
                        <path
