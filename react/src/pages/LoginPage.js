...
import { useAccount } from '../contexts/AccountContext'; // Use AccountContext here
        ...
        <div>
            <Row style={{ marginTop: '10px' }}>
                ...
                <Col md={10} lg={11} className="main-content">
                    ...
                    <div style={{ backgroundImage: `url(${outdoorsy})`, borderRadius: '30px' }}>
                        <section className="container py-3 py-md-5 py-xl-8">
